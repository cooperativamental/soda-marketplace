...
export const contentToolTip = {
    ...
    <div className="p-2">
              ...
              <a href="https://docs.solana.com/developing/programming-model/transactions#instructions"  target="_blank" rel="noopener noreferrer" className="inline-block">
                <Button
                  size="sm"
                  variant="text"
    ...
    <div className="p-2">
              ...
              <a href="https://docs.solana.com/developing/programming-model/accounts" target="_blank" rel="noopener noreferrer" className="inline-block">
                <Button
                  size="sm"
                  variant="text"
                  className="flex items-center gap-1 capitalize text-blue-custom"
